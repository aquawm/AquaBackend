...
namespace AquaBackend.Controllers
{
    public class ClientsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Portfolio,Bank,Account,Holder")] Client client)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Portfolio,Bank,Account,Holder")] Client client)
        {
            if (id != client.Id)
            {
                return NotFound();
